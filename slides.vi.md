...
<div class="gates">
  <div class="gatecard">
    ...
    <p>Trước khi Rio viết một dòng, người dùng cuối thấy nó sẽ làm <em>gì</em> và <em>vì sao</em> — trả lời “ok”, hoặc chỉnh lại.</p>
  </div>
  <div class="gatecard">
    <div class="g">⏸ CỔNG 2 · NGƯỜI DÙNG CUỐI</div>
    <h3>Người dùng cuối duyệt bản xem thử</h3>
    <p>Rio ship lên <code>dev</code> trước. Người dùng cuối mở link xem thử và xác nhận đúng ý trước khi đi tiếp.</p>
  </div>
  <div class="gatecard">
